...
// Method to fetch the immediate for i operations
            ...
            // Either BNE or JALR
                ...
                if(opcode == 0x67) { //JALR
                    ...
                    if (regs[rs1] != regs[rs2]) {
                        // cout << "R1: " << regs[rs1] << ", R2: " << regs[rs2] << endl;
...
bool ALU::setPC() {
    if(pc_write){
        ...
        pc += 4;
        // cout << "Incrementing target: " << pc << endl;
    }      
    // pc_target = 0;
